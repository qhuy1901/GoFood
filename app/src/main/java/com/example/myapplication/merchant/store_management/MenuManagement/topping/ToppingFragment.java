...
public class ToppingFragment extends Fragment {
    ...
    private void initUi()
    {
        fabAddNewTopping = binding.fragementToppingFabAddNewTopping;
        rcvTopping = binding.fragementToppingRcvTopping;
    ...
    private void getProductListFromRealtimeDatabase()
    {
        ...
        DatabaseReference myRef = database.getReference().child("stores").child(storeId).child("menu").child("toppings");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fabAddNewTopping.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent switchActivityIntent = new Intent(getContext(), AddTopingActivity.class);
