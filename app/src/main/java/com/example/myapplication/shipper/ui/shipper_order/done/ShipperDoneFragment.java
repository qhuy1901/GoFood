...
import com.example.myapplication.databinding.FragmentShipperDoneBinding;
...
public class ShipperDoneFragment extends Fragment {
    ...
    private FragmentShipperDoneBinding binding;
    private ShipperDoneAdapter adapter;
    private List<Order> orders;

    private void initUi()
    {
        rcvOrder = binding.fragmentShipperDoneRcvOrders;

        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        rcvOrder .setLayoutManager(linearLayoutManager);

        orders = new ArrayList<>();
        adapter = new ShipperDoneAdapter(orders, getContext());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentShipperDoneBinding.inflate(inflater, container, false);
